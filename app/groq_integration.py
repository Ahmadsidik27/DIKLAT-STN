...
👉 Jawab berdasarkan pengetahuan umum dan best practices otomotif Indonesia. Jika ada uncertainty, sebutkan dengan jelas."""
            ...
            if not is_valid:
                ...
                return {
                    ...
                    'provider': 'Groq',
                    'from_docs': False,
                    'error': '❌ Pertanyaan tidak berkaitan dengan otomotif/bengkel. Silakan tanyakan tentang diagnosis mesin, prosedur perbaikan, sparepart, atau topik otomotif lainnya.'
                }
            
            # ✅ STEP 5: ADD TRANSPARENCY NOTE jika pakai general knowledge
            if not from_docs:
                answer = f"{answer}\n\n📌 **CATATAN:** Jawaban ini {source_note}. Untuk hasil paling akurat, cek manual resmi atau service manual untuk spesifikasi exact."
